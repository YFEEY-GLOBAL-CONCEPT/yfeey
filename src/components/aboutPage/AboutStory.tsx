        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          <div className="space-y-12">
            <div>
              ...
              <h2 className="text-gray-900 text-4xl md:text-5xl lg:text-6xl max-w-md leading-[1.1]">
                Where We <span className="text-primary italic">Started</span>
              </h2>
            </div>
            
            <div className="pt-8 border-l-4 border-primary pl-10">
              <div className="text-6xl md:text-8xl font-bold text-primary leading-none mb-2">5+</div>
